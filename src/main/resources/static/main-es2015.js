...
let LoginComponent = class LoginComponent {
    constructor(router, restService, dataService) {
        this.router = router;
...
let DetailViewComponent = class DetailViewComponent {
    constructor(route, restService, dialog) {
        this.route = route;
        this.restService = restService;
        this.dialog = dialog;
        this.columns = [
...
DetailViewComponent.ctorParameters = () => [
...
let ReviewViewComponent = class ReviewViewComponent {
    constructor(restService, data) {
        this.restService = restService;
        this.data = data;
        this.columns = [
            {
...
ReviewViewComponent.ctorParameters = () => [
    { type: _services_rest_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"] },
...
let GradeDetailsViewComponent = class GradeDetailsViewComponent {
    constructor(restService, route) {
        this.restService = restService;
        this.route = route;
        this.columns = [
            {
...
GradeDetailsViewComponent.ctorParameters = () => [
    { type: _services_rest_rest_service__WEBPACK_IMPORTED_MODULE_2__["RestService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] }
];
